...
public class DataGenerator {
    ...
    public static String generateCity(String locale) {
        var cities = new String[]{"Майкоп", "Горно-Алтайск", "Уфа", "Улан-Удэ", "Махачкала", "Донецк", "Магас", "Начальчик",
                ...
                "Тюмень", "Ульяновск", "Херсон", "Челябинск", "Ярославль", "Санкт-Петербург", "Севастополь", "Биробиджан",
